 ...
 *         &lt;element name="ReportServerTimeZoneInfo" type="{http://schemas.microsoft.com/sqlserver/reporting/2010/03/01/ReportServer}TimeZoneInformation" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *       &lt;anyAttribute/&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
...
public class ServerInfoHeader {
    ...
    @XmlElement(name = "ReportServerTimeZoneInfo")
    protected TimeZoneInformation reportServerTimeZoneInfo;
    @XmlAnyAttribute
    ...
    /**
     * Gets the value of the reportServerTimeZoneInfo property.
     * 
     * @return
     *     possible object is
     *     {@link TimeZoneInformation }
     *     
     */
    public TimeZoneInformation getReportServerTimeZoneInfo() {
        return reportServerTimeZoneInfo;
    }

    /**
     * Sets the value of the reportServerTimeZoneInfo property.
     * 
     * @param value
     *     allowed object is
     *     {@link TimeZoneInformation }
     *     
     */
    public void setReportServerTimeZoneInfo(TimeZoneInformation value) {
        this.reportServerTimeZoneInfo = value;
    }
